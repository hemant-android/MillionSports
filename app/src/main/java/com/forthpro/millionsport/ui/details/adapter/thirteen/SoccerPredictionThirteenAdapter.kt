package com.forthpro.millionsport.ui.details.adapter.thirteen
...
class SoccerPredictionThirteenAdapter(private val mContext: Context, private val position: Int) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is ViewHolder0 -> {
                ...
                var adapter = SoccerPredictionThirteenInnerAdapter(mContext, this.position)
