package com.forthpro.millionsport.ui.change_language.adapter
...
class LanguageChangeAdapter(private val mContext: Context) :
    androidx.recyclerview.widget.RecyclerView.Adapter<LanguageChangeAdapter.ViewHolder>() {
