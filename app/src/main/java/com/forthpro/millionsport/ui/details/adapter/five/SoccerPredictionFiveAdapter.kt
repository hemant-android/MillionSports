package com.forthpro.millionsport.ui.details.adapter.five
...
class SoccerPredictionFiveAdapter(private val mContext: Context, private val position: Int) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is ViewHolder0 -> {
                ...
                var adapter = SoccerPredictionFiveInnerAdapter(mContext, this.position)
