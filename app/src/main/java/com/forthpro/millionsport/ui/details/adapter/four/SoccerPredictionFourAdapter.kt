package com.forthpro.millionsport.ui.details.adapter.four
...
class SoccerPredictionFourAdapter(private val mContext: Context, private val position: Int) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is ViewHolder0 -> {
                ...
                var adapter = SoccerPredictionFourInnerAdapter(mContext, this.position)
