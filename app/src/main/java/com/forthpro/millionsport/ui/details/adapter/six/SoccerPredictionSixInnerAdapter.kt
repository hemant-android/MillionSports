package com.forthpro.millionsport.ui.details.adapter.six
...
class SoccerPredictionSixInnerAdapter(private val mContext: Context, private val position: Int) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        when (viewType) {
            ...
            1 -> {
                view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.row_prediction_tab_four_inner_sport_6, parent, false);
