...
class FavouriteViewModel(app: Application, private val appRepository: AppRepository) :
    ...
    private val _getFavResponse = MutableLiveData<Event<Resource<FavMatchesResponse>>>()
    val getFavResponse: LiveData<Event<Resource<FavMatchesResponse>>> = _getFavResponse

    private val _getFavResponseFilter = MutableLiveData<Event<Resource<FavMatchesResponse>>>()
    val getFavResponseFilter: LiveData<Event<Resource<FavMatchesResponse>>> = _getFavResponseFilter
    ...
    private fun handleResponse(response: retrofit2.Response<FavMatchesResponse>): Event<Resource<FavMatchesResponse>>? {
