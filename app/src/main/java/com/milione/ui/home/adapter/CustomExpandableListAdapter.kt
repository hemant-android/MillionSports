package com.milione.ui.home.adapter
...
class CustomExpandableListAdapter internal constructor(
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.row_popular_competition_item_inner, null)
        }
        val tvLeagueName = convertView!!.findViewById<TextView>(R.id.tvLeagueName)
        tvLeagueName.text = expandedListText
        return convertView
    }
